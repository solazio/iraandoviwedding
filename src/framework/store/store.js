    ...
    state: {
        ...
        qas: [
            { id: 1,
              ...
              answer: "Our recommendation is to arrive to Kiev on Wednesday evening, if you want to attend our oraganised tour on Thursday morning. On Friday, July 12th we will have a church wedding ceremony and if you wish to witness it, would be good to arrive on Thursday evening. In case you're not interested in the events mentioned earlier, it is best to arrive on Friday evening."},
            { id: 2,
              question: 'How to get to the city center from airport?',
              answer: 'Please keep in mind there are two airports in Kiev. KBP - is the main one where BA, Ukrainian International, and Ryanair fly to. And IEV - which is inside the city where Wizzair fly to. There are official taxis which you can book on arrival as soon as you pick up your luggage and get to meet and greet point. Outside of the airport you will see lined up taxis. For the most part they take cards but drivers might prefer cash. The other option is to use Uber in case you have internet connection on your phone.'},
            { id: 3,
              question: 'Where to exchange money?',
              answer: "Local currency is UAH , Ukrainian Hryvna. There is a possibility to exchange money at the airport at a decent rate. Once you pick up your luggage and get out to the greet and meet point please turn left. Right away on the left you will see 3 money exchanging booths. Please DON'T change money there and walk another 50 meters and you will see a bank branch: ПУМБ. Feel free to exchange money there."},
            { id: 4,
              question: 'Where should we stay?',
              answer: 'We recommend staying in the city center around Golden Gate Monument or Khreshatyk street (metro stations: Khreshatyk, Zolotye Vorota, Maidan Nezalezhnosti). Booking.com and Airbnb have many good options and we will be happy to help with language if needed.'},
            { id: 5,
              question: 'What’s a tradition when it comes to wedding gifts?',
              answer: 'We made a commitment, some time ago, together through life, we were destined to go. To save you looking, shopping and buying, here is an idea, we hope you’ll like trying! Come to our wedding, to wish us both well, and please make a donation to our wishing well, now that we have saved you all the fuss. We can’t wait for you to celebrate with us.'},
            { id: 6,
              question: 'How to get to the venue?',
              answer: 'Uber is very easy, common , and affordable in case you have internet on your mobile. If not you can use a local taxi.'},
            { id: 7,
              question: 'What is the dress code?',
              answer: 'There is no strict dress code as long as it’s not jeans and running shoes. We want everybody to feel comfortable.'},
            { id: 8,
              question: 'Where to do hair and make up?',
              answer: "For the ladies we recommend <a href='https://gbar.com.ua'>G-Bar</a> or <a href='http://dreambar.com.ua/'>Dream Bar</a>. It offers hair and make up all in one. For the guys use <a href='https://m15.ua/'>M15</a> and you won't be dissapointed. Please let us know if you need help making a booking."},
            { id: 9,
              question: 'Where to eat Ukranian food?',
              answer: "<a href='http://pervak.kiev.ua/en/'>Pervak</a>, <a href='http://borisov.com.ua/en/kanapa'>Kanapa</a>, <a href='http://borisov.com.ua/en/ostannya-barykada'>Ostannya Barykada/Last Barricade</a> are amoung our favorites. If you access their websites' you can find the location in their contact section."},
            { id: 10,
